            ...
            <div className="space-y-2">
              ...
              <div className="text-sm text-gray-600 space-y-2">
                ...
                <p className="bg-amber-50 border border-amber-200 text-amber-800 p-2.5 rounded text-xs text-left">
                  ⚠️ <strong>Important Note / Warning:</strong> If this unit is linked to any active products in the system, deletion will be blocked and you must disable it instead to preserve sales history.
                </p>
              </div>
            </div>
